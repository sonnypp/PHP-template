                ...
                <div class="usBox_1 f_l">
                   ...
                   <?php $form = $this->beginWidget('CActiveForm',array(
                        ...
                        <table align="left" border="0" cellpadding="3" cellspacing="5" width="100%">
                            <tbody><tr>
                                    <td align="right" width="25%"><?php echo $form->labelEx($user_login,'username'); ?></td>
                                    <td width="75%"><?php echo $form->textField($user_login,'username',array('size'=>25,'class'=>'inputBg')); ?>
